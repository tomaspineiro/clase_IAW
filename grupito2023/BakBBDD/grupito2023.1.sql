...
-- Tiempo de generación: 17-02-2023 a las 14:47:00
...
--
-- DROP DATABASE IF EXISTS grupito2023;
-- CREATE DATABASE grupito2023;
-- USE grupito2023;
-- --------------------------------------------------------
...
--
ALTER TABLE `detallesPedidos`
  MODIFY `idDetallesPedidos` int(11) NOT NULL AUTO_INCREMENT;
